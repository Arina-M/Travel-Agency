...
?>
                <div class="card <?php if (!$_smarty_tpl->tpl_vars['card']->value->getHot()) {?>nothot<?php }?>" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="700" data-aos-once="true">
...
">
                        ...
                        <div class="sb-content">
                            ...
                            <div class="country-photo"><img src="<?php echo $_smarty_tpl->tpl_vars['card']->value->getCollageImage();?>
.jpg"></div>
                        </div>
                    </div>
